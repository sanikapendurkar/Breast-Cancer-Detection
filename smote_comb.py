...
from imblearn.over_sampling import SMOTE  # You can use ADASYN here if preferred
...
# Splitting the data before applying SMOTE (or ADASYN)
...
def plot_comparison_roc(models, X_test, y_test):
    ...
    plt.title('SMOTE Comparison of ROC Curves')
